...
def home(request):
    ...
    if request.method == 'POST':
        ...
        if form_de.is_valid():
            ...
            subject, from_email, to = 'Contact Form Cams Wood', settings.EMAIL_HOST_USER, 'severin.wenger@ebmnet.ch'
    ...
    return render(request, 'home.html', {'date': date, 'page': page, 'images': images, 'form_de': form_de, 'submitted': submitted})